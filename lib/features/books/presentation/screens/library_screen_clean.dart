...
class LibraryScreenClean extends ConsumerWidget {
  const LibraryScreenClean({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    // For now, we'll use the existing bookshelf provider
    // TODO: Create clean architecture version of bookshelf provider
          ...
          children: [
            ...
            GradientButton(
              onPressed: () => Navigator.of(context).pushReplacement(
                MaterialPageRoute(builder: (context) => const HomeScreenClean()),
              ),
              icon: Icons.search,
              text: 'Browse Books',
            ),

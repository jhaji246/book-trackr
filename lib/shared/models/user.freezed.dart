...
class _$UserImpl implements _User {
  const _$UserImpl(
      ...
      @HiveField(5) this.lastLoginAt,
      @HiveField(6) this.isEmailVerified = false});
...
abstract class _User implements User {
  const factory _User(
      ...
      @HiveField(5) final DateTime? lastLoginAt,
      @HiveField(6) final bool isEmailVerified}) = _$UserImpl;
